...
import seederData from "./desertFun.seeder.json";
...
const DesertFunSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DesertFunSeederDialogComponent);
