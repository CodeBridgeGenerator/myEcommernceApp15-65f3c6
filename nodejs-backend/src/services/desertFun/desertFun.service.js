const { DesertFun } = require("./desertFun.class");
const createModel = require("./desertFun.model");
const hooks = require("./desertFun.hooks");
...
module.exports = function (app) {
  ...
  app.use("/desertFun", new DesertFun(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("desertFun");

  // Get the schema of the collections 
  app.get("/desertFunSchema", function (request, response) {
